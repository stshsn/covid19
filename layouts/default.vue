  ...
  head(): MetaInfo {
    ...
    return {
      ...
      link: [
        {
          rel: 'canonical',
          href: `https://covid19-fukui.com${this.$route.path}`
        }
      ],
      meta: [
        {
          hid: 'author',
          name: 'author',
          content: this.$tc('エンジニア有志')
        },
        {
          hid: 'description',
          name: 'description',
          content: this.$tc(
            '当サイトは新型コロナウイルス感染症 (COVID-19) に関する最新情報を提供するために、福井高専卒のエンジニアが開設したものです'
          )
        },
        {
          hid: 'og:site_name',
